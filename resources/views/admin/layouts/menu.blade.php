            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{ url('/category') }}" ><span> <i class="fas fa-users"></i> </span><span class="hide-menu">Category</span></a></li>
                    	<li> <a href="{{ url('/products') }}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Products</span></a></li>
                        <li> <a href="{{ url('/subcategory') }}" ><span> <i class="fas fa-cross"></i> </span><span class="hide-menu">Sub Category</span></a></li>
                        <li> <a href="{{ url('/brands') }}" ><span> <i class="fas fa-cross"></i> </span><span class="hide-menu">Brand</span></a></li>
                        <li> <a href="{{ url('/colors') }}" ><span> <i class="fas fa-cross"></i> </span><span class="hide-menu">Colors</span></a></li>
                        <li> <a href="{{ url('/size') }}" ><span> <i class="fas fa-cross"></i> </span><span class="hide-menu">Sizes</span></a></li>
                        <li> <a href="{{ url('/units') }}" ><span> <i class="fas fa-cross"></i> </span><span class="hide-menu">Units</span></a></li>
