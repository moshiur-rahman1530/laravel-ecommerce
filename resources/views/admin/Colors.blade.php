...
//   var ColorName =$('#ColorNameId').val();
//   addColor(ColorName);
// })
// function addColor(ColorName, ColorDes, ColorImg){
//   $('#ColorAddConfirmBtn').html("<div class='spinner-border spinner-border-sm' role='status'></div>")
//   axios.post('/colors', {
//     name: ColorName,
//   }).then(function(response){
//       $('#ColorAddConfirmBtn').html("Save");
//       if(response.status==200){
//               if (response.data == 1) {
