                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{$detailsProduct->product_img}}" alt="Image">
                        </div>
                    ...
                    <div class="col-lg-7 pb-5">
                        ...
                        <h3 class="font-weight-semi-bold mb-4"><span>{{$detailsProduct->product_price}}</span> TK</h3>
                        ...
                        <div class="d-flex mb-3">
                          ...
                          @foreach(json_decode($detailsProduct->size_id) as $size)
                          @php
                            $sizeName = App\Models\Size::SizeName($size)
                          @endphp
                        ...
                        <div class="d-flex mb-4">
                            <p class="text-dark font-weight-medium mb-0 mr-3">Colors:</p>
                              @foreach(json_decode($detailsProduct->color_id) as $color)
                              @php
                              $colorName = App\Models\Color::findColor($color)
                              @endphp
                              <div class="custom-control custom-radio custom-control-inline">
